...
/// <summary>
/// Represents a tray menu item with properties that update the native backend immediately.
/// </summary>
public sealed class NativeTrayMenuItem
{
    ...
    internal NativeTrayMenuItem(IStatusIconBackend backend, string itemId, string label)
    {
        _backend = backend;
        Id = itemId;
        _label = label;
    ...
    public string Label
    {
        ...
        set
        {
            ...
            _label = value;
            _backend.SetMenuItemLabel(Id, value);
        }
    }
    ...
    public bool IsEnabled
    {
        ...
        set
        {
            ...
            _isEnabled = value;
            _backend.SetMenuItemEnabled(Id, value);
        }
    }
    ...
    public bool IsChecked
    {
        ...
        set
        {
            ...
            _isChecked = value;
            _backend.SetMenuItemChecked(Id, value);
        }
    }
    ...
    public NativeTrayMenuItem WithEnabled(bool enabled)
    {
        _isEnabled = enabled;
        return this;
    }
    ...
    /// <returns>This item for method chaining.</returns>
    public NativeTrayMenuItem WithChecked(bool isChecked)
    {
